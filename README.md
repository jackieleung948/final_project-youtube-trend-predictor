...
- database.py - creates schema on first run
...
- cap_incidence.py - per keyword, the share of nonzero training buckets containing a collection-capped hour. Produces cap_incidence.csv
...
- labels_compute.py - computes trending_25 and trending_50 labels from the manually downloaded Google Trends CSVs into labels/backtest_labels.csv
- make_panel.py - combines all the predictions of the models into a single panel
- plot_rotimaker.py - plots the rotimakingmachine series with one-step forecasts
